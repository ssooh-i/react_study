...
// 				if (errorCause === "email") {
// 					setEmailMsg(
// 						"입력하신 이메일이 존재하지 않습니다. 다시 입력해주세요."
// 					);
// 					setCheckEmail(false);
// 				} else if (errorCause === "password") {
// 					setPwdMsg(
// 						"입력하신 비밀번호가 존재하지 않습니다. 다시 입력해주세요."
// 					);
// 					setCheckPwd(false);
// 				}
// 			} else {
...
// 				/>
// 				<LoginStyled.OutputText className={checkEamil ? "success" : "error"}>
// 					{emailMsg}
// 				</LoginStyled.OutputText>
...
// 				/>
// 				<LoginStyled.OutputText className={checkPwd ? "success" : "error"}>
// 					{pwdMsg}
// 				</LoginStyled.OutputText>

// 				<LoginStyled.FootBtnBox>
// 					<LoginStyled.FootButton
// 						onClick={onSubmit}
// 						type="submit"
// 						disabled={!isAllValid}
// 					>
...
// 					<a href="./register">
// 						<LoginStyled.FootButton>회원가입</LoginStyled.FootButton>
// 					</a>
// 				</LoginStyled.FootBtnBox>
